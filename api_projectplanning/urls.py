...
urlpatterns = [
    ...
    path('mark_cumplido_fulfilled_by_compromiso', views.mark_cumplido_fulfilled_by_compromiso_id, name="mark_cumplido_fulfilled_by_compromiso"),
    #path('mark_cumplido_fulfilled_by_etapa', views.mark_cumplido_fulfilled_by_etapa_id, name="mark_cumplido_fulfilled_by_etapa"),
